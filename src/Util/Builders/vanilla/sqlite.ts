...
const generateInsertArray = (
	...
	return {
		...
		resolver: async (source, args: { values: Record<string, any>[] }, context, info) => {
			...
			const columns = extractSelectedColumnsSQLFormat(info, queryName, table) as Record<string, Column>
...
>(
	...
	const tables = Object.fromEntries(
		Object.entries(rawTables).filter(([key, value]) => is(value, SQLiteTable))
